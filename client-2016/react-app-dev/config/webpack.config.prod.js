...
const cssFilename = 'static/css/' + require(paths.appPackageJson).name + '.css';
...
module.exports = {
  ...
  output: {
    ...
    filename: 'static/js/' + require(paths.appPackageJson).name + '.js',
    chunkFilename: 'static/js/' + require(paths.appPackageJson).name + '.chunk.js',
  ...
  resolve: {
    ...
    alias: {
      ...
      '@NodeSocial': paths.appSrc + '/components/Projects/NodeSocial',
